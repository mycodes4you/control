    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header" style="text-align: center;">
          <div class="row">
            <div class="col-md-7">
              <h4 class="card-title">Grupo <?= $grupo_nom ?> -> <?= $carrera_nom ?>
                <small class="description"> </small>
              </h4>
            </div>
            <div class="col-md-5">
              <a class="btn btn-warning" href="inicio.php?accion=grupos"><b><i class="fa fa-user-plus"></i> Regresar</b></a>
        ...
        <div class="card-body">
          ...
          <table class="table">
            ...
            <tbody class="tbody-custom">
              <?php while($lista_alumnos = $consulta_alumnos->fetch_array()): ?>
                <tr class="menu-item">
                  <td><center><img class="avatar border-gray" alt="..." src="<?= $lista_alumnos['alumno_foto'] ?>"></center></td>
                  <td><?= $lista_alumnos['alumno_apaterno'] ?> </td>
                  <td><?= $lista_alumnos['alumno_amaterno'] ?> </td>
                  <td><?= $lista_alumnos['alumno_1ernombre'] ?> <?= $lista_alumnos['alumno_2donombre'] ?></td>
                  <td>
                    <input type="hidden" name="grupo_id" :value="grupo.grupo_id">
                    <a class="btn btn-info btn-sm btn-icon" href="inicio.php?accion=ver_grupo&grupo_id=<?= $lista_grupo['grupo_id'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
