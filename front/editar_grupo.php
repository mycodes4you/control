        ...
        <div class="card ">
		 ...
		 <div class="col-md-12">
			<div class="card">
			    ...
			    <div class="row">
			    	<div class="col-md-9">
			        <h4 class="card-title">Edita los datos del Grupo <?= $grupo_nom ?> -> <?= $carrera_nom ?><small class="description"></small></h4>
			      </div>
			      <div class="col-md-3">
	          ...
	          <input type="text" class="form-control" id="grupo_nombre" autocomplete="on" value="<?= $datosG['grupo_nombre'] ?>">
	        </div>

	        <div class="form-group">
			      <label for="carrera_id">Carrera</label>
			      <select class="form-control" id="carrera_id" required="yes">
					    <option value="<?= $datosG['carrera_id'] ?>"><?= $carrera_nom ?></option>
			    ...
			    <div class="form-group">
			      ...
			      <select class="form-control" id="grupo_semestre" required="yes">
			      	<?php $sem = $datosG['grupo_semestre']; ?>
					    <option value="<?= $datosG['grupo_semestre'] ?>"><?= $lista_semestres[$sem] ?></option>
